        ...
        <div class="col-lg-12">
            ...
            <div class="float-right">
                <div class="dropdown mr-4">
                    <a href="#" class="text-white dropdown-toggle" id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo isset($_SESSION['username']) ? $_SESSION['username'] : '' ?> </a>
                    <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                        <a class="dropdown-item" href="javascript:void(0)" id="return_to_login"><i class="fa fa-arrow-left"></i> Return to Login</a>
...
<script>
    document.getElementById("logout").addEventListener("click", function() {
        ...
        if (confirmLogout) {
            window.location.href = "login.php"; // Redirect to logout script
        }
    });
